        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex-1 space-y-4 overflow-y-auto p-2 px-4">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full rounded-lg border border-gray-300 bg-white p-2.5 text-sm text-[#182641] transition-all duration-200 hover:border-[#DC3C22]/40 focus:border-[#DC3C22] focus:ring-2 focus:ring-[#DC3C22]/20 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:hover:border-[#DC3C22]/40 dark:focus:border-[#DC3C22] dark:focus:ring-[#DC3C22]/30"
            ...
            <div className="mb-6">
              <div className="mb-3 block text-sm font-semibold text-[#182641] dark:text-gray-300">
                <span className="flex items-center space-x-1">
                  <FaTags className="h-3 w-3 text-[#DC3C22]" />
            ...
            <button
              ...
              className="w-full rounded-lg bg-gradient-to-r from-[#DC3C22] to-[#DC3C22]/90 px-4 py-3 font-medium text-white shadow-md transition-all duration-300 hover:shadow-lg hover:from-[#DC3C22]/90 hover:to-[#DC3C22] focus:outline-none focus:ring-2 focus:ring-[#DC3C22]/50 disabled:cursor-not-allowed disabled:opacity-70"
            >
