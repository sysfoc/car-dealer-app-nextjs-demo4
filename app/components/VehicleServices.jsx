...
//   MdSupport,
// } from "react-icons/md";
// import { BiSolidDetail, BiTrendingUp } from "react-icons/bi";
...
//       description:
//         "We help you get the highest value for your vehicle with professional valuation",
//     },
//     {
//       icon: <FaClock className="text-2xl" />,
//       title: "Quick Process",
//       description:
//         "Our streamlined process makes selling faster than traditional methods",
//     },
//     {
//       icon: <FaShieldAlt className="text-2xl" />,
//       title: "Secure Process",
//       description:
//         "Complete protection with verified processes and secure transactions",
//     },
//     {
//       icon: <FaUsers className="text-2xl" />,
//       title: "Expert Network",
//       description:
//         "Access to our extensive network of automotive professionals",
//     },
//   ];
...
//       description:
//         "Get in touch with our automotive experts who will guide you through the entire selling process.",
...
//       description:
//         "Our experts will evaluate your vehicle and provide a comprehensive market analysis.",
...
//       description:
//         "We help facilitate the sale through our network of dealers and automotive professionals.",
...
//       description:
//         "Learn how to prepare your vehicle to maximize its appeal and value in the market.",
...
//       description:
//         "Understand current market trends and how they affect your vehicle value.",
...
//       description:
//         "Learn about secure payment methods and transaction protection strategies.",
...
//       description:
//         "Key factors to consider when selling your vehicle through professional channels.",
...
//                   Learn about our professional car selling services. Our
//                   automotive experts help you navigate the selling process with
//                   confidence and security.
//                 </p>
//                 <button
//                   onClick={handleContactUs}
//                   className="group relative inline-flex transform items-center justify-center overflow-hidden rounded-xl bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 px-8 py-4 text-lg font-semibold text-white shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-orange-300 dark:focus:ring-orange-800"
//                 >
//                   <div className="absolute inset-0 bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
...
//               Our professional team guides you through every step of the car
//               selling process. Here&apos;s how we help you sell your vehicle
//               with confidence.
//             </p>
//           </div>
...
//                     <div className="mb-4 h-px bg-gradient-to-r from-blue-500 to-cyan-500"></div>
