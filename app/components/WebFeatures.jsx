...
export default function WebFeatures() {
  ...
  return (
    <section className="py-8 bg-gradient-to-br from-slate-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
           All Radius websites are performance-optimized and feature-rich. Manage updates yourself or rely on our expert support—our user-friendly platform makes it easy.
           </p>
        </div>
